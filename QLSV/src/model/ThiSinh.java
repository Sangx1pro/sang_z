...
public class ThiSinh implements Serializable{
	...
	public String toString() {
		return "ThiSinh [maThiSinh=" + maThiSinh + ", tenThiSinh=" + tenThiSinh + ", queQuan=" + queQuan + ", gioiTinh="
				+ gioiTinh + ", diemMon1=" + diemMon1 + ", diemMon2=" + diemMon2 + ", diemMon3=" + diemMon3 + "]";
	}
	@Override
	public int hashCode() {
		return Objects.hash(diemMon1, diemMon2, diemMon3, gioiTinh, maThiSinh, queQuan, tenThiSinh);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
				...
				&& maThiSinh == other.maThiSinh && Objects.equals(queQuan, other.queQuan)
